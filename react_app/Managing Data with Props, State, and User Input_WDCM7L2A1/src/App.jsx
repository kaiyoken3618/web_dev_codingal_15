...
// Lesson 1 App.jsx — just rendered a static Navbar:
//
...
// Goal   : Wrap the app in AppProvider so every component can share state.
//          Add UserPreferenceForm to demonstrate props + state in action.
// Output : Navbar with theme toggle + a name input and age picker below it.
